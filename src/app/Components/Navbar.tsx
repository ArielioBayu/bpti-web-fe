...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-slate-200">
      ...
      <div className="hidden lg:block bg-black border-b border-slate-100 py-2">
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 transition-shadow duration-200 ${isScrolled ? 'shadow-md shadow-slate-100' : ''
        }`}>
